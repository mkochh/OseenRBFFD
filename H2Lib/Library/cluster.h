...
typedef enum {
  ...
  H2_PCA,
  /** @brief Domain decomposition adaptive clustering.*/
  DD_ADAPTIVE,
  /** @brief Domain decomposition regular clustering.*/
  DD_REGULAR,
  /** @brief Domain decomposition with simultaneous subdivision clustering.*/
  DD_SIMSUB,
  /** @brief Coupled domain decomposition clustering.*/
  DD_COUPLED,
  /** @brief Coupled domain decomposition clustering version 2*/
  DD_COUPLED_V2,
  /** @brief Domain decomposition adaptive clustering with interaction aware interface clustering*/
  IA_ADAPTIVE,
  /** @brief Coupled domain decomposition clustering with interaction aware interface clustering*/
  IA_COUPLED
} clustermode;
